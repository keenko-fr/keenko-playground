...
`docs/project/ui.md` is the canonical project-owned document for durable visual and interaction decisions. Linear owns feature/product scope and acceptance decisions. Code and configuration own executable implementations and exact values such as theme tokens, CSS values, and component code.
